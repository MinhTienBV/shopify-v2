...
/* harmony import */ var _modules_FixHeight__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/FixHeight */ "./src/scripts/modules/FixHeight.js");
...
/* harmony import */ var _modules_BrowserDetection__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/BrowserDetection */ "./src/scripts/modules/BrowserDetection.js");
...
/* harmony import */ var _modules_ConvertSvg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/ConvertSvg */ "./src/scripts/modules/ConvertSvg.js");
...
/* harmony import */ var _modules_ADA__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/ADA */ "./src/scripts/modules/ADA.js");
/* harmony import */ var _modules_UserAgent__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/UserAgent */ "./src/scripts/modules/UserAgent.js");
/* harmony import */ var _modules_Header__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/Header */ "./src/scripts/modules/Header.js");
/* harmony import */ var _modules_Menu__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/Menu */ "./src/scripts/modules/Menu.js");
/* harmony import */ var _modules_AnimationScrollPage__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/AnimationScrollPage */ "./src/scripts/modules/AnimationScrollPage.js");
 // // js Custom
...
var ADA = /*#__PURE__*/function () {
  ...
  _createClass(ADA, [{
    ...
    key: "dectectFocus",
    value: function dectectFocus() {
      $('.main-menu-ul > li > a').on('focusin', function () {
    ...
    key: "removetabindexdots",
    value: function removetabindexdots() {
      setTimeout(function () {
    ...
    value: function initADA() {
      ...
      $('.tiny-prev,.tiny-next').keydown(function (e) {
        if (e.keyCode === 13) {
    ...
    value: function animationEle() {
      ...
      if ($('body').hasClass('has-animation')) {
        ...
        this.$elems.each(function (index, ele) {
          ...
          if ($elm.hasClass(_this2.addClassAni)) {
            return true;
          }
          ...
          if (_this2.wintop > _this2.topcoords - _this2.offset) {
            $elm.addClass(_this2.addClassAni);
          }
...
/***/ "./src/scripts/modules/ConvertSvg.js":
/*!*******************************************!*\
  !*** ./src/scripts/modules/ConvertSvg.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ConvertSvg": () => (/* binding */ ConvertSvg),
...
var ConvertSvg = /*#__PURE__*/function () {
  function ConvertSvg() {
    _classCallCheck(this, ConvertSvg);

    this.$hasSvg = $('img.img-svg:not(.lazy)');
  }

  _createClass(ConvertSvg, [{
    key: "appendsvg",
    value: function appendsvg(data, $img) {
    ...
    key: "convertSvg",
    value: function convertSvg() {
      var _this = this;

      if (this.$hasSvg.length) {
        this.$hasSvg.each(function (index, e) {
          var $img = $(e);
          var imgURL = $img.attr('src');

          if (imgURL) {
            $.get(imgURL, function (data) {
              _this.appendsvg(data, $img);
            }, 'xml');
          }
        });
      }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ FixHeight)
/* harmony export */ });
...
var FixHeight = /*#__PURE__*/function () {
  function FixHeight() {
    _classCallCheck(this, FixHeight);

    this.$fixHeight = $('.fix-height');
  }

  _createClass(FixHeight, [{
    key: "callFixHeight",
...
var FormAnimation = /*#__PURE__*/function () {
  ...
  _createClass(FormAnimation, [{
    ...
    value: function checkValue() {
      ...
      this.$hasFormAni.find(this.formControl).each(function (index, el) {
  ...
  _createClass(LazyLoadImage, [{
    ...
    value: function lazyLoadAllPrint() {
      ...
      if ($imgLazy.length) {
        ...
        $imgLazy.each(function (index, element) {
...
var Popup = /*#__PURE__*/function () {
  function Popup() {
    ...
    this.$popcontent = ".".concat(this.popcontent);
  ...
  _createClass(Popup, [{
    ...
    value: function openPopup() {
      ...
      this.$html.on('click', this.$openPopup, function (e) {
        ...
        var tmpWidthContent = $(tmpContent).data('content'); // console.log('openPopup click')

        $(ele).addClass(_this.isClick);

        _this.loadLazyOnLoad();

        if ($(tmpContent).hasClass(_this.modPopupStatic)) {
        ...
        _this.$html.addClass(htmlClass).addClass(_this.popupOpen);
    ...
    value: function clickOutSite() {
      ...
      this.$html.on('click', ".".concat(this.maskOverlay), function () {
        _this3.closePopup();
      });
    ...
    value: function clickToggle() {
      ...
      $(document).on('click', this.dropToggle, function (e) {
        ...
        if (eleParent.hasClass(_this3.show)) {
          ...
          $dropdownRemove.removeClass(_this3.show);
          $(_this3.dropdownMenu).addClass(_this3.hidden);
